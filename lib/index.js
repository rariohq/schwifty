...
exports.plugin = {
    ...
    register: (server, options) => {
        ...
        if (typeof options.skipDBConnectionPing !== 'undefined') {
            Hoek.assert(collector.skipDBConnectionPing === null, 'Schwifty\'s skipDBConnectionPing option can only be specified once.');
            collector.skipDBConnectionPing = options.skipDBConnectionPing;
        }
    }
};
...
internals.initialize = async (server) => {
    ...
    if(!collector.skipDBConnectionPing) {
